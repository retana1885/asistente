...
**URL:** https://www.medicamentosplm.com/home/productos/ferranina-complex-grageas/126/101/7686/77
...
Complejo polimaltosado férrico 220 mg (equivalente a 60 mg de hierro elemental)

Ácido fólico 350 µg

Mononitrato de tiamina (vitamina B 1 ) 1.0 mg

Riboflavina (vitamina B 2 ) 1.3 mg

Clorhidrato de piridoxina (vitamina B 6 ) 1.6 mg

Cianocobalamina (vitamina B 12 ) 2.0 µg

Ácido ascórbico (vitamina C) 60 mg

Nicotinamida (vitamina B 3 ) 20 mg

Pantotenato de calcio (vitamina B 5 ) 10 mg

Excipiente, c.b.p. 1 gragea.

## INDICACIONES TERAPÉUTICAS

INDICACIONES TERAPÉUTICAS: Complejo de vitaminas y hierro para la suplementación durante el embarazo, anemia nutricional, anemia ferropénica con componente macrocítico, anemia por deficiencia de hierro, anemia megaloblástica, deficiencia de los componentes de la fórmula.

## PROPIEDADES FARMACÉUTICAS

FARMACOCINÉTICA Y FARMACODINAMIA: FERRANINA ® COMPLEX es un hematínico de simple posología, que por las características de sus componentes ofrece múltiples ventajas en el manejo de las anemias, tanto ferroprivas como megaloblásticas.
...
REACCIONES SECUNDARIAS Y ADVERSAS: A dosis terapéutica, ninguna. Ocasionalmente pueden presentarse algunas alteraciones del tránsito intestinal como diarrea o estreñimiento transitorio, náusea, vómito y pirosis así como regurgitación eventual con sabor a algunas vitaminas de la fórmula.

PRECAUCIONES EN RELACIÓN CON EFECTOS DE CARCINOGÉNESIS, MUTAGÉNESIS, TERATOGÉNESIS Y SOBRE LA FERTILIDAD: El hierro férrico (trivalente) ligado al oligosácarido polimaltosado es prácticamente atóxico. Ninguna acción teratogénica ha sido descrita hasta el momento ni para las sales ferrosas como tampoco para el complejo polimaltosado férrico o las vitaminas de la fórmula. El complejo polimaltosado férrico puede ser usado durante el embarazo y la lactancia.

## INTERACCIONES MEDICAMENTOSAS Y DE OTRO GÉNERO

INTERACCIONES MEDICAMENTOSAS Y DE OTRO GÉNERO: Existe la posibilidad de interacción del hierro con D-penicilamina, tetraciclina, cloranfenicol, cimetidina, carbonato de calcio y colestiramina. El ácido fólico puede bloquear la acción de las sulfas y del metotrexato y puede disminuirse la absorción de este ácido fólico con anovulatorios orales, alcohol y anticonvulsivantes.
...
PRECAUCIONES GENERALES: Algunas veces la vitamina C favorece la litiasis renal.
