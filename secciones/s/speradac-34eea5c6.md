...
**URL:** https://www.medicamentosplm.com/home/productos/speradac-tabletas-masticables/35/101/46951/220
...
Montelukast sódico equivalente a 4 o 5 mg de montelukast
...
Función respiratoria: En comparación con el placebo, SPERADAC ® causó mejorías significativas en los parámetros de la función respiratoria (VEF 1 y flujo espiratorio máximo, FEM), tanto en cada estudio como en el análisis combinado:
...
|  | SPERADAC ® n = 795 | Placebo n = 530 |
| --- | --- | --- |
| VEF 1 matutino (% de cambio del valor inicial) | 10.4* | 2.7 |
...
VEF 1 matutino (% de cambio del valor inicial)
...
• El grado y la duración de la disminución del VEF 1 en el transcurso de 60 minutos después del esfuerzo (medidos por el porcentaje de disminución del área bajo la curva de VEF 1 después del esfuerzo).

• El porcentaje máximo de disminución del VEF 1 después del esfuerzo.

• El tiempo transcurrido hasta la recuperación del VEF 1 hasta un margen de 5% respecto a su valor anterior al esfuerzo.
