...
**URL:** https://www.medicamentosplm.com/home/productos/motilium-tabletas/84/101/8731/210
...
– Náuseas y vómito de origen funcional, orgánico, infeccioso o dietético o inducidas por radioterapia o farmacoterapia.
...
Farmacodinamia: Domperidona es un antagonista de dopamina con propiedades antieméticas. Domperidona no cruza con gran facilidad la barrera hematoencefálica. En personas que usan domperidona, especialmente en adultos, los efectos secundarios extrapiramidales son muy raros, pero domperidona promueve la liberación de prolactina desde la pituitaria. Su efecto antiemético podría deberse a una combinación de sus efectos periféricos (gastrocinéticos) y al antagonismo de los receptores de dopamina en la zona desencadenante quimiorreceptora, la cual se ubica fuera de la barrera hematoencefálica, en el área postrema.
...
Información de estudios clínicos: La seguridad de MOTILIUM ® fue evaluada en 1,221 pacientes con gastroparesis, dispepsia, reflujo gastroesofágico, u otra condición relacionada en 45 estudios clínicos, incluyendo la base de datos de seguridad. Todos los pacientes fueron ³ 15 años y recibieron al menos una dosis de MOTILIUM ® .

Ligeramente menos de la mitad (553/1,221) de los pacientes fueron diabéticos. La mediana de la dosis total diaria fue de 80 mg (rango de 10 a 160 mg), con 230 pacientes recibiendo una dosis superior a 80 mg. La mediana de la duración de la exposición fue de 56 días (rango de 1 a 2,248 días).
...
| Sistema/órgano clase Reacción adversa | MOTILIUM ® (n = 1,221) % |
| --- | --- |
| Alteraciones psiquiátricas |
| Depresión | 2.5 |
| Ansiedad | 1.6 |
| Disminución o pérdida de la libido | 1.5 |
...
| Ginecomastia | 5.3 |
| Entumecimiento de los senos | 4.4 |
| Galactorrea | 3.3 |
| Amenorrea | 2.9 |
| Dolor de senos | 2.3 |
| Menstruación irregular | 2.0 |
| Alteraciones de la lactancia | 1.6 |
...
| Alteraciones de la piel y tejido subcutáneo |
| Urticaria | 0.7 |
| Alteraciones del sistema reproductivo y senos |
| Galactorrea | 0.8 |
| Inflamación de senos | 0.5 |
...
Adicionalmente a los eventos adversos reportados durante los estudios clínicos mencionados antes, las siguientes reacciones adversas han sido reportadas (tabla 3 y 4 ).
...
| Alteraciones del sistema inmune |
| --- |
| Muy rara | Reacción anafiláctica (incluyendo choque anafiláctico). |
| Alteraciones psiquiátricas |
| Muy rara | Agitación, nerviosismo. |
| Alteraciones del sistema nervioso |
| Muy rara | Alteración extrapiramidal, convulsión. |
| Alteraciones cardiacas |
| Muy rara | Muerte súbita, arritmias ventriculares serias. |
| Alteraciones de la piel y tejido subcutáneo |
| Muy rara | Angioedema. |
| Alteraciones renales y urinarias |
| Muy rara | Retención urinaria. |
| Investigaciones |
| Muy raras | Anormalidades en las pruebas de funcionamiento hepático, incremento en el nivel de prolactina. |

Alteraciones del sistema inmune

Muy rara

Reacción anafiláctica (incluyendo choque anafiláctico).
...
Alteración extrapiramidal, convulsión.

Alteraciones cardiacas

Muy rara

Muerte súbita, arritmias ventriculares serias.
...
Anormalidades en las pruebas de funcionamiento hepático, incremento en el nivel de prolactina.
...
| Alteraciones del sistema inmune |
| --- |
| No se conoce | Reacción anafiláctica (incluyendo choque anafiláctico). |
| Alteraciones psiquiátricas |
| Poco común | Agitación, nerviosismo. |
| Alteraciones del sistema nervioso |
| Raras | Convulsión alteraciones extrapiramidales . |
| Alteraciones cardiacas |
| Muy raras | Muerte súbita, arritmias ventriculares serias. |
| Alteraciones de la piel y tejido subcutáneo |
| No se conoce | Angioedema. |
| Alteraciones renales y urinarias |
| Poco común | Retención urinaria. |
| Investigaciones |
| Poco común | Pruebas de funcionamiento hepático anormales. |
| Raras | Incremento en los niveles séricos de prolactina. |
...
Convulsión alteraciones extrapiramidales .
...
Incremento en los niveles séricos de prolactina.
...
Un incremento en el riesgo de arritmias ventriculares serias y muerte súbita ha sido reportado en algunos estudios epidemiológicos.
...
PRECAUCIONES EN RELACIÓN CON EFECTOS DE CARCINOGÉNESIS, MUTAGÉNESIS, TERATOGÉNESIS Y SOBRE LA FERTILIDAD: Con una dosis alta, tóxica para la madre (más de 40 veces la dosis humana recomendada), se observaron efectos teratogénicos en la rata. No se observó teratogenicidad en ratones y conejos.
...
Con la combinación de domperidona 10 mg cuatro veces al día con ketoconazol 200 mg dos veces al día, se vio una prolongación media de QTc de 9.8 msec durante el periodo de observación, con cambios en puntos de tiempo individuales que variaron de 1.2 a 17.5 msec.
...
– Agonistas dopaminérgicos (bromocriptina, L-dopa) cuyos efectos periféricos indeseables como trastornos digestivos, náuseas y vómito suprime sin contrarrestar sus propiedades centrales.
...
PRECAUCIONES GENERALES: Cuando se emplean antiácidos o agentes antisecretores concomitantemente, éstos no deben ser administrados junto con las formulaciones orales de MOTILIUM ® , y deberán administrarse después de las comidas, no antes de las mismas.
...
Uso en alteraciones renales:

Debido a que la vida media de eliminación de la domperidona es prolongada en los pacientes con daño hepático severo, con administraciones repetidas, la frecuencia de administración debe ser reducida a una o dos veces al día, dependiendo de la severidad del daño, y también puede ser necesario disminuir la dosis.
...
DOSIS Y VÍA DE ADMINISTRACIÓN: Se recomienda la administración oral de MOTILIUM ® antes de las comidas. Si se administra posterior a los alimentos, la absorción del medicamento puede reducirse en cierta forma.

Adultos y adolescentes (mayores de 12 años y que pesan 35 kg o más):

| Formulación | Dosificación | Dosis máxima por día |
| --- | --- | --- |
| Comprimidos (10 mg/tableta) | 1 a 2 tabletas t.i.d. a q.i.d. | 8 tabletas (80 mg) |
...
Comprimidos (10 mg/tableta)

1 a 2 tabletas t.i.d. a q.i.d.

8 tabletas (80 mg)

Infantes y niños: Las tabletas no son adecuadas para usarse en niños que pesan menos de 35 kg.
...
Observaciones: Se recomienda tomar MOTILIUM ® antes de los alimentos. Si se toma después de los alimentos la absorción del medicamento puede verse retrasada. No se debe intentar administrar las tabletas a niños por debajo de los 5 años.
...
Como la glándula hipófisis se localiza fuera de la barrera hematoencefálica, MOTILIUM ® puede inducir a un incremento en los niveles plasmáticos de prolactina. En raros casos, esta hiperprolactinemia puede aumentar el riesgo de manifestaciones neuroendocrinológicas como galactorrea y ginecomastia.

Cuando la barrera hematoencefálica es inmadura (como en los niños menores de un año) o dañada, la posible aparición de efectos neurológicos secundarios no puede ser totalmente excluida. También han sido reportadas raras reacciones alérgicas como rash cutáneo y urticaria.
...
PRESENTACIONES: Caja con 30 tabletas de 10 mg.
