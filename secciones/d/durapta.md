...
**URL:** https://www.medicamentosplm.com/home/productos/durapta-solucion-inyectable/84/101/33544/162
...
Tabla 1 Concentraciones plasmáticas de DURAPTA ® después de una administración única
...
| 500 mg durante 1 hora | 0.5 | 1 | 2 | 3 | 4 | 6 | 7 | 8 | 9 |
| 20.2 | 20.9 | 6.13 | 2.69 | 1.41 | 0.45 | – | 0.13 | – |
...
Pseudomanas aerugino sa (cepas reistentes a ceftazidima).
...
| Patógeno | Concentraciones mínimas (µg/ml) | Inhibitorias | Difusión en disco (zona de diámetro en mm) |
| --- | --- | --- | --- |
| S | I | R | S | I | R |
...
| Clasificación por órgano o sistema | NP | cIAI | DURAPTA ® (n = 477) | Meropenem4 (n = 469) |
| --- | --- | --- | --- | --- |
| DURAPTA ® (n = 485) | Piperacilina/ tazobactam1 imipenem2 (n = 221/263) |
...
Tabla 4 Reacciones adversas al medicamento identificadas después de que se inició la venta de DURAPTA ®
...
| Infección intraabdominal complicada | 500 mg | Cada 8-h | 1 | 1 5-14 días** |
...
| Depuración de | = | peso (kq) x (140 - años de edad) |
| --- | --- | --- |
...
Tabla 6 Almacenamiento de la suspensión para infusión preparada con suspensión salina normal o dextrosa al 5%

| Diluyente | Tiempo de estabilidad en (horas) | 2-8°C (en refrigeración) |
| --- | --- | --- |
| Temperatura ambiente |
| Suspensión salina normal | 12 | 72* |
| Dextrosa al 5% + | 4 | 24* |
